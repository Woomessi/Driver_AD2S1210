...
#define SPI4_SCK_GPIO_AF                GPIO_AF5_SPI4 //SPI3对应AF6
#define SPI4_SCK_GPIO_CLK_ENABLE()      do{ __HAL_RCC_GPIOE_CLK_ENABLE(); }while(0)   /* PB口时钟使能 */

#define SPI4_MOSI_GPIO_PORT             GPIOE
#define SPI4_MOSI_GPIO_PIN              GPIO_PIN_6
#define SPI4_MOSI_GPIO_AF               GPIO_AF5_SPI4
#define SPI4_MOSI_GPIO_CLK_ENABLE()     do{ __HAL_RCC_GPIOE_CLK_ENABLE(); }while(0)   /* PB口时钟使能 */

#define SPI4_MISO_GPIO_PORT             GPIOE
#define SPI4_MISO_GPIO_PIN              GPIO_PIN_5
#define SPI4_MISO_GPIO_AF               GPIO_AF5_SPI4
#define SPI4_MISO_GPIO_CLK_ENABLE()     do{ __HAL_RCC_GPIOE_CLK_ENABLE(); }while(0)   /* PB口时钟使能 */

#define SPI4_SPI                        SPI4
#define SPI4_SPI_CLK_ENABLE()           do{ __HAL_RCC_SPI4_CLK_ENABLE(); }while(0)    /* SPI1时钟使能 */
